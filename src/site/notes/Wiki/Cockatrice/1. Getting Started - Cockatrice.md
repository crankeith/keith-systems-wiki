---
{"dg-publish":true,"dg-path":"Cockatrice/1. Getting Started - Cockatrice.md","permalink":"/cockatrice/1-getting-started-cockatrice/","updated":"2025-06-24T09:05:15.715-04:00"}
---
...
>[!NOTE]
> Once Cockatrice has loaded, go to the menu and click `Help > Check For Card Updates` to update the card database. Go through all the steps, choosing the defaults. If any new sets are added, make sure to click `Yes` when prompted. **If you are still having troubles with cards in your decks, double check and make sure all sets are enabled by going to `Card Database > Manage Sets`**.
